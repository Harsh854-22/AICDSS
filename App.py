...
howto= """Welcome to the <b>AI-Powered Clinical Decision Support System</b>,
...
<br><br>
Here’s a quick guide to help you get started:<br><br> <b>How to Begin:</b> Simply type your messages in the textbox to converse with the chatbot and press enter!<br><br> The bot will respond with the most appropriate answers to your queries. For now, let’s keep it SIMPLE while SAHA diligently work on enhancing its capabilities for the future.
"""


# Create the gradio demo
with gr.Blocks(css = """#col_container { margin-left: auto; margin-right: auto;} #chatbot {height: 520px; overflow: auto;}""") as demo:
  gr.HTML('<h1 align="center">AI-Powered Clinical Decision Support System </h1>')
  with gr.Accordion("Welcome to AI-CDSS", open=True):
      gr.HTML(howto)
  chatbot = gr.Chatbot()
  msg = gr.Textbox()
  ...
  def respond(message, chat_history):
    ...
    responses = [
        "Thank you for using our AI-Powered Clinical Decision Support System. Please provide the symptoms you're experiencing, and I'll do my best to predict the possible disease.",
        ...
        "Greetings! I am a specialized AI-Powered Clinical Decision Support System trained to predict potential diseases based on the symptoms you provide. Kindly list your symptoms explicitly.",
        "Welcome to the AI-Powered Clinical Decision Support System. To assist you accurately, please share your symptoms in explicit detail.",
        "Hi there! I'm a AI-Powered Clinical Decision Support System specialized in analyzing symptoms to suggest possible diseases. Please provide your symptoms explicitly.",
        "Hey! I'm your AI-Powered Clinical Decision Support System. Describe your symptoms with as much detail as you can, and I'll generate potential disease predictions.",
        "How can I assist you today? I'm a AI-Powered Clinical Decision Support System trained to predict diseases based on symptoms. Please be explicit while describing your symptoms.",
        "Hello! I'm a AI-Powered Clinical Decision Support System capable of predicting diseases based on the symptoms you provide. Your explicit symptom description will help me assist you better.",
        ...
        "Hi, I'm the AI-Powered Clinical Decision Support System. I've been trained to predict diseases from symptoms. The more explicit you are about your symptoms, the better I can assist you.",
        ...
        "Hello! I'm a AI-Powered Clinical Decision Support System with expertise in predicting diseases from symptoms. Please describe your symptoms explicitly to receive accurate insights.",
        ]
    # Random goodbyes
    goodbyes = [
